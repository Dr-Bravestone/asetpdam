...
// Route 
Route::get('/reportaset', [AssetController::class, 'reportaset'])->middleware('auth');
Route::get('/reportmaintenance', [MaintenanceController::class, 'reportmaintenance'])->middleware('auth');
Route::get('/reportborrow', [BorrowAssetController::class, 'reportborrow'])->middleware('auth');
Route::get('/reportqr', [AssetController::class, 'reportqr'])->middleware('auth');
Route::get('/reportqr/print', [AssetController::class, 'printqr'])->middleware('auth');
Route::post('/printqr/{id}', [AssetController::class, 'printSelected'])->name('printqr.print');
Route::get('/printqr/{id}/download', [AssetController::class, 'downloadQRCode'])->name('printqr.download');
