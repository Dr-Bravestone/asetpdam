        ...
        <form method="post" action="/assets/{{ $asset->slug }}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror"
                    id="jumlah" required autofocus value="{{ old('jumlah', $asset->jumlah) }}" min="1" oninput="validateJumlah(this)">
                @error('jumlah')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="garansi" class="form-control @error('garansi') is-invalid @enderror"
                    id="garansi" required autofocus value="{{ old('garansi', $asset->garansi) }}" min="1" oninput="validateJumlah(this)">
                @error('garansi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror"
                    id="harga" required autofocus value="{{ old('harga', $asset->harga) }}" min="1" oninput="validateJumlah(this)">
