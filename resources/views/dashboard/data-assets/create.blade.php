        ...
        <form method="post" action="/assets" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror"
                    id="jumlah" required autofocus value="{{ old('jumlah') }}" min="1" oninput="validateJumlah(this)">
                @error('jumlah')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select name="tahun" id="tahun" class="form-control @error('tahun') is-invalid @enderror" required autofocus>
                    @php
                        $currentYear = date('Y');
                        $startYear = 1990;
                    @endphp
            ...
            <label for="Garansi" class="form-label">Sisa Garansi</label>
            <div class="input-group mb-3">
                <input type="number" name="garansi" class="form-control @error('garansi') is-invalid @enderror"
                    id="garansi" required autofocus value="{{ old('garansi') }}" min="1" oninput="validateJumlah(this)">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror"
                    id="harga" required autofocus value="{{ old('harga') }}" min="1" oninput="validateJumlah(this)">
            ...
            <label for="make_qr" class="form-label">Buat QR code</label>
            <div class="input-group mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="make_qr" id="inlineRadio2" value="0" checked required>
    ...
    <script>
        ...
        function validateYear(input) {
            ...
            if (year.length === 4 && (year < 1900 || year > currentYear)) {
                input.setCustomValidity("Please enter a valid year between 1900 and " + currentYear);
            } else {
