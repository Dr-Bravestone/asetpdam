...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Pemeliharaan</h1>
    </div>
    ...
    <div class="col-lg-8">
        <form method="post" action="/maintenances/{{ $maintenance->id }}" class="mb-5">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" value="{{ old('jumlah', $maintenance->jumlah) }}" required min="1" oninput="validateJumlah(this)">
                @error('jumlah')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="biaya" class="form-control @error('biaya') is-invalid @enderror" id="biaya" value="{{ old('biaya', $maintenance->biaya) }}" min="1" oninput="validateJumlah(this)">
                @error('biaya')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
