        ...
        <form method="post" action="/borrowassets/{{ $pinjamaset->id }}" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tgl_pinjam" class="form-control @error('tgl_pinjam') is-invalid @enderror"
                    id="tgl_pinjam" value="{{ old('tgl_pinjam', $pinjamaset->tgl_pinjam) }}" required <script>
        ...
        if (input.value < 1) {
            ...
            <div class="mb-3">
                ...
                <input type="number" name="durasi" class="form-control @error('durasi') is-invalid @enderror"
                    id="durasi" value="{{ old('durasi', $pinjamaset->durasi) }}" required min="1" oninput="validateJumlah(this)">
                @error('durasi')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
